# Infinite Storage - Setup help

Everything you need to get **Infinite Storage** running, step by step. If something goes wrong, check *Troubleshooting* at the end.

## What you need

- Minecraft **Bedrock Edition** 1.20.50 or newer (Windows, phone, console or a Bedrock server)

## Install and start

1. Download **`Infinite-Storage-v3.2.0.mcaddon`** from the [Releases page](../../releases) - or directly from this repository.
...
- Get the **Void Key** from the creative inventory (category *Equipment*) or with `/give @s infstorage:void_chest_key`.
- Right-click the key to open your personal infinite storage menu.
- While your storage chest is open, other players cannot open it.
